...
const SUGGESTION_BRANDS = [
  "adobe","affinity water","aldi","alo","amazon","amex","american airlines","apple","argos","arsenal fc","asda",
  "b&q","barclays","booking.com","bolt","boots","brent","british airways","bt","bupa",
  "carrefour", "cercanias","chelsea fc","chatgpt","co-op","costco","currys",
  "deliveroo","domino's",
  "easy jet","ebay","ee","el corte ingles","eurostar","enterprise", "elgato",
  "five guys","formula1",
  "google","greggs","grok","grind",
  "hsbc","hyperoptic",
  "iberia","iceland","ikea","insite energy","itsu",
  "jd sports","john lewis",
  "kfc","klarna",
  "leeds building society","let's do this","lidl","lner","lottery","lululemon",
  "m&s","mcdonald's","mercadona","microsoft","morrisons","malaga cf",
  "nando’s","national express","netflix","nba","nfl",
  "o2","octopus energy","odeon",
  "paramount+","paypal","play station","pret a manger","prime",
  "real madrid","renfe","rent","revolut","ryanair",
  "sainsbury's","sky","sports direct","spotify","strava","starbucks","subway",
  "tesco","tfl","third space","three","tk.max","trainline","tui",
  "uber",
...
const BRAND_LOGO_RULES = [
  ...
  { keywords: ["argos"],                  logo: "assets/logos/argos.png" },
  { keywords: ["arsenal fc"],             logo: "assets/logos/arsenal.png" },
  ...
  { keywords: ["bolt"],                   logo: "assets/logos/bolt.png" },
  ...
  { keywords: ["bt"],                     logo: "assets/logos/bt.png" },
  { keywords: ["bupa"],                   logo: "assets/logos/bupa.png" },
  { keywords: ["carrefour"],              logo: "assets/logos/carrefour.png" },
  { keywords: ["cercanias"],              logo: "assets/logos/cercanias.png" },
  { keywords: ["chelsea fc"],             logo: "assets/logos/chelsea.png" },
  { keywords: ["chatgpt"],                logo: "assets/logos/chatgpt.png" },
  { keywords: ["co-op"],                  logo: "assets/logos/coop.png" },
  { keywords: ["costco"],                 logo: "assets/logos/costco.png" },
  { keywords: ["currys"],                 logo: "assets/logos/currys.png" },
  ...
  { keywords: ["ee"],                     logo: "assets/logos/ee.png" },
  { keywords: ["el corte ingles"],        logo: "assets/logos/elcorteingles.png" },
  { keywords: ["elgato"],                 logo: "assets/logos/elgato.png" },
  { keywords: ["enterprise"],             logo: "assets/logos/enterprise.png" },
  { keywords: ["eurostar"],               logo: "assets/logos/eurostar.png" },
  { keywords: ["five guys"],              logo: "assets/logos/fiveguys.png" },
  { keywords: ["formula1"],               logo: "assets/logos/formulaone.png" },
  { keywords: ["google"],                 logo: "assets/logos/google.png" },
  { keywords: ["greggs"],                 logo: "assets/logos/greggs.png" },
  { keywords: ["grok"],                   logo: "assets/logos/grok.png" },
  { keywords: ["grind"],                  logo: "assets/logos/grind.png" },
  ...
  { keywords: ["iceland"],                logo: "assets/logos/iceland.png" },
  ...
  { keywords: ["jd sports"],              logo: "assets/logos/jdsports.png" },
  { keywords: ["john lewis"],             logo: "assets/logos/johnlewis.png" },
  { keywords: ["kfc"],                    logo: "assets/logos/kfc.png" },
  { keywords: ["klarna"],                 logo: "assets/logos/klarna.png" },
  { keywords: ["leeds building society"], logo: "assets/logos/leedsbuildingsociety.png" },
  ...
  { keywords: ["lululemon"],              logo: "assets/logos/lululemon.png" },
  { keywords: ["m&s"],                    logo: "assets/logos/mands.png" },
  { keywords: ["mcdonald's"],             logo: "assets/logos/mcdonalds.png" },
  { keywords: ["malaga cf"],              logo: "assets/logos/malagacf.png" },
  ...
  { keywords: ["nando’s"],                logo: "assets/logos/nandos.png" },
  { keywords: ["national express"],       logo: "assets/logos/nationalexpress.png" },
  { keywords: ["netflix"],                logo: "assets/logos/netflix.png" },
  { keywords: ["nba"],                    logo: "assets/logos/nba.png" },
  { keywords: ["nfl"],                    logo: "assets/logos/nfl.png" },
  { keywords: ["o2"],                     logo: "assets/logos/o2.png" },
  ...
  { keywords: ["pret a manger"],          logo: "assets/logos/pret.png" },
  { keywords: ["prime"],                  logo: "assets/logos/prime.png" },
  { keywords: ["real madrid"],            logo: "assets/logos/realmadrid.png" },
  ...
  { keywords: ["sports direct"],          logo: "assets/logos/sportsdirect.png" },
  { keywords: ["spotify"],                logo: "assets/logos/spotify.png" },
  { keywords: ["strava"],                 logo: "assets/logos/strava.png" },
  { keywords: ["starbucks"],              logo: "assets/logos/starbucks.png" },
  { keywords: ["subway"],                 logo: "assets/logos/subway.png" },
  ...
  { keywords: ["three"],                  logo: "assets/logos/three.png" },
  { keywords: ["tk.max"],                 logo: "assets/logos/tkmax.png" },
  { keywords: ["trainline"],              logo: "assets/logos/trainline.png" },
  { keywords: ["tui"],                    logo: "assets/logos/tui.png" },
  { keywords: ["uber"],                   logo: "assets/logos/uber.png" },
  { keywords: ["virgin media"],           logo: "assets/logos/virginmedia.png" },
  { keywords: ["vodafone"],               logo: "assets/logos/vodafone.png" },
